...
source_catalog: _bmad-output/implementation-artifacts/sprint-migration-2026-09-19.yaml
...
source_obligations: []
requirements: [FR4, FR19, FR52, NFR2, NFR25]
source_additional_requirements: [NFR20]
engineering_conditions: [OPS-01, DB-CHANGE-01, METRICS-01, METRICS-02, METRICS-03, APP-HOST-01]
...
- [ ] T7 真实PG、跨进程与传输故障矩阵（AC1–11；METRICS-03）
  ...
  - [ ] Android10+/iOS16+实际设备的C07：受理→断网/后台/进程终止→身份确认→原job/cursor补读，无新POST，无旧owner连接；实际原生失败可恢复。编译/模拟器只计对应范围，Mac/签名/真机缺项不伪造通过。
...
- `_bmad-output/implementation-artifacts/sprint-migration-2026-09-19.yaml`：catalog/准备顺序、条件绑定和3.1暂停。
- `_bmad-output/implementation-artifacts/sprint-delivery-contract-2026-09-19.yaml`：FR/NFR归属及无本Story专属source_obligations。
