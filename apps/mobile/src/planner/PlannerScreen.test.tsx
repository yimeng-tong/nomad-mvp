...
function createApiClient(overrides: Partial<PlannerApiClient> = {}): PlannerApiClient {
  ...
  return {
    ...
    editSlot: vi.fn(async (_planId, slotId, request) => ({
      ...
      current_version_id: 'pv_edit',
      edit_event_id: 'edit_123',
      undo_token: 'undo_123',
      undo_expires_at: '2026-07-02T00:00:08.000Z',
      changed_slot: {
        slot_id: slotId,
        day_index: 0,
        slot_index: 0,
    ...
    getRecentAction: vi.fn(async () => ({ plan_id: 'pl_123', plan_rev: 1, action: null })),
    undoEdit: vi.fn(async () => ({
      plan_id: 'pl_123',
      plan_rev: 2,
      current_version_id: 'pv_undo',
      undo_event_id: 'undo_event_123',
      undone_edit_event_id: 'edit_123',
    })),
