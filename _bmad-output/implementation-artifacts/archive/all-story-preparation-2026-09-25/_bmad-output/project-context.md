...
Coordinate the existing1.0 task and9.1 task using Sprint active_workstreams; preserve shared code and current evidence. Primary CURRENT may remain1.0 while9.1 progresses separately. Daily Node/pnpm stays in WSL; designated macOS native builds are allowed, Windows-native tooling remains excluded. APP-BUILD-01/APP-HOST-01/APP-DISTRIBUTE-01 are per-Story conditions; real installs/signing/TestFlight and provider evidence remain runtime gates.
