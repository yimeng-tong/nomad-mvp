...
- Current catalog/delivery use the 2026-09-19 versions; preserve the 2026-09-15/17 snapshots. Source display order stays stable; preparation order is 9.1, the preserved 1.0–8.6 queue, then 9.2. Numeric IDs do not imply execution chronology.
