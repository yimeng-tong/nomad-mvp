...
本次用户已批准主提案与合同附录，批准记录为 `_bmad-output/planning-artifacts/capacitor-scope-decision-2026-09-19.md`。新增 FR52/NFR25 与 Epic 9，首期交付 Web/PWA、Android 签名测试 APK、iOS TestFlight；支持 Android 10+ / iOS 16+ 手机竖屏。9.1 前置交付可安装的既有入口/宿主，原业务 Story 完成各自 App 验收，9.2 最后交付测试包及升级/跨端证据。
...
FR52/NFR25；9.1 安装与宿主在执行顺序前置，9.2 最终测试交付在本期业务之后。
